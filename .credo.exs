    ...
    %{
      ...
      checks: %{
        enabled: [
          ...
          # DuplicatedCode — repeated contract validation clauses are clearer than metaprogramming
          {Credo.Check.Design.DuplicatedCode, false},
          # ExpensiveEmptyEnumCheck — explicit length assertions are clearer in boundary tests
          {Credo.Check.Warning.ExpensiveEmptyEnumCheck, false},
          # LongQuoteBlocks — protocol fixtures and schema vectors contain legitimate quote blocks
